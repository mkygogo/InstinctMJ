...
class AlgorithmCfg(InstinctRlPpoAlgorithmCfg):
    ...
    teacher_logdir: object = field(default_factory=lambda: os.path.expanduser(
        "~/Data/instinct_mjlab_logs/instinct_rl/g1_perceptive_shadowing/20260111_103654_g1Perceptive_4MotionsKneelClimbStep1_concatMotionBins__GPU0_from20260108_032900"
    ))
