...
### Training
```python
from instinct_mjlab.tasks.shadowing.beyondmimic.config.g1.beyondmimic_plane_cfg import G1BeyondMimicPlaneEnvCfg
from instinct_mjlab.tasks.shadowing.beyondmimic.config.g1.agents.beyondmimic_ppo_cfg import G1BeyondMimicPPORunnerCfg
...
```bash
python source/instinct_mjlab/instinct_mjlab/tasks/shadowing/beyondmimic/play.py --checkpoint /path/to/checkpoint.pt
```
