...
import instinct_mjlab.utils.math as instinct_math
...
class base_pos_offset_since_motion_refresh(ManagerTermBase):
    ...
    def __init__(self, cfg: ObservationTermCfg, env: ManagerBasedEnv):
        ...
        self.base_pos_marker = torch.zeros_like(self.asset.data.root_link_pos_w)  # (num_envs, 3)

    def reset(self, env_ids: Sequence[int] | None = None) -> None:
        self.base_pos_marker[env_ids] = self.asset.data.root_link_pos_w[env_ids]
    ...
    def __call__(
        ...
        # (num_envs, 3)
        self.base_pos_marker[landmarker_refresh_mask] = self.asset.data.root_link_pos_w[landmarker_refresh_mask]
        # (num_envs, 3)
        base_pos_offset = self.asset.data.root_link_pos_w - self.base_pos_marker
