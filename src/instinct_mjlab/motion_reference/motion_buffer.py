...
omni_log = logging.getLogger(__name__)
...
class MotionBuffer:
    ...
    def __init__(
        ...
        """The robot entity to access robot states."""
        ...
        _joint_limits = self.articulation_view.data.joint_pos_limits[0]  # remove the env dimension
